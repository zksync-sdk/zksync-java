...
public interface AsyncProvider {
     ...
     */
    CompletableFuture<AccountState> getState(String accountAddress);
     ...
     */
    CompletableFuture<TransactionFeeDetails> getTransactionFee(TransactionFeeRequest feeRequest);
     ...
     * @return Details of fee amount for transaction execution
     */
    CompletableFuture<TransactionFeeDetails> getTransactionFee(TransactionFeeBatchRequest feeRequest);
     ...
     */
    CompletableFuture<String> submitTx(ZkSyncTransaction tx, EthSignature ethereumSignature, boolean fastProcessing);
     ...
     * @return Hash of the sent transaction in ZkSync network
     */
    CompletableFuture<String> submitTx(ZkSyncTransaction tx, boolean fastProcessing);
     ...
     * @return Hash of the sent transaction in ZkSync network
     */
    CompletableFuture<String> submitTx(ZkSyncTransaction tx, EthSignature ...ethereumSignature);
     ...
     */
    CompletableFuture<List<String>> submitTxBatch(List<Pair<ZkSyncTransaction, EthSignature>> txs, EthSignature ethereumSignature);
     ...
     * @return List of hashes of the sent transactions in ZkSync network
     */
    CompletableFuture<List<String>> submitTxBatch(List<Pair<ZkSyncTransaction, EthSignature>> txs);
     ...
     */
    CompletableFuture<TransactionDetails> getTransactionDetails(String txHash);
     ...
     */
    CompletableFuture<EthOpInfo> getEthOpInfo(Integer priorityOperationId);
